              ...
              }
              {
                hasRole(currentUser, "ROLE_USER") && (
                  <NavDropdown title="Menu Items" id="appnavbar-menu-items-dropdown" data-testid="appnavbar-menu-items-dropdown" >
                    <NavDropdown.Item as={Link} to="/menuitems/list" data-testid="appnavbar-menu-items-list">List</NavDropdown.Item>
                    <NavDropdown.Item as={Link} to="/menuitems/create" data-testid="appnavbar-menu-items-create">Create</NavDropdown.Item>
                  </NavDropdown>
                )
              }
              {
