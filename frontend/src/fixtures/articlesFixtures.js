const articlesFixtures = {
    oneArticle: {
        "id": 1,
        "title": "after hours - the weeknd (sped up)",
        "url": "https://www.youtube.com/watch?v=WccqQ_sWfVY",
        "explanation": "weeknd",
    ...
    threeArticles: [
        ...
        {
            "id": 4,
            "title": "give it up to me - sean paul (sped up)",
